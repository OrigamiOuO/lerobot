...
def make_act_baseline_pre_post_processors(
    ...
    """Creates the pre- and post-processing pipelines for the ACT Baseline policy.
    ...
    Args:
        config (ACTBaselineConfig): The ACT Baseline policy configuration object.
