...
"""Processor for Diffusion-Dino policy."""
...
def make_diffusion_dino_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for diffusion-dino policy.
    ...
    Args:
        config: The configuration object for the diffusion-dino policy,
