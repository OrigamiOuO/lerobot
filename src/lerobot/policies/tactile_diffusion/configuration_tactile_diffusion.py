...
@PreTrainedConfig.register_subclass("tactile_diffusion")
@dataclass
class TactileDiffusionConfig(PreTrainedConfig):
    ...
    # The original implementation doesn't sample frames for the last 4 steps,
    # which avoids excessive padding and leads to improved training results.
    drop_n_last_frames: int = 4  # horizon - n_action_steps - n_obs_steps + 1
    ...
    def validate_features(self) -> None:
        ...
        - Check if tactile features are present when use_tactile_features=True
        - Validate tactile feature dimensions
        - Ensure compatibility between state, tactile, and other features
        """
        # TODO: Implement custom validation for tactile features
