...
# Option 1: Use default transform configuration
...
- **`inhand_camera_jitter`**: Extra light affine jitter for `inhand` camera frames, enabled by default independently from the standard transforms.
